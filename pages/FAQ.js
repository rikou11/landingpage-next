          ...
          <div class="grid sm:grid-cols-2 gap-4 md:gap-8">
            ...
            <div class="bg-gray-100 rounded-lg p-5">
              <div class="flex justify-between items-center border-b gap-4 pb-4 mb-4">
                <h3 class="text-red-500 sm:text-lg md:text-xl font-semibold">How does the product work?</h3>
            ...
            <div class="bg-gray-100 rounded-lg p-5">
              <div class="flex justify-between items-center border-b gap-4 pb-4 mb-4">
                <h3 class="text-red-500 sm:text-lg md:text-xl font-semibold">What are the features?</h3>
            ...
            <div class="bg-gray-100 rounded-lg p-5">
              <div class="flex justify-between items-center border-b gap-4 pb-4 mb-4">
                <h3 class="text-red-500 sm:text-lg md:text-xl font-semibold">What about integrations?</h3>
            ...
            <div class="bg-gray-100 rounded-lg p-5">
              <div class="flex justify-between items-center border-b gap-4 pb-4 mb-4">
                <h3 class="text-red-500 sm:text-lg md:text-xl font-semibold">Is support available?</h3>
