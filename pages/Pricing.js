          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-6 md:mb-8">
            ...
            <div class="flex flex-col border rounded-lg p-4 pt-6">
              <div class="mb-12">
                ...
                <div class="space-y-2">
                  ...
                  <div class="flex gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 shrink-0 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="flex flex-col gap-8 mt-auto">
                ...
                <a href="#" class="block bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-red-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Join for free</a>
              </div>
            </div>
            
      
            
            <div class="flex flex-col border-2 border-red-500 rounded-lg relative p-4 pt-6">
              <div class="mb-12">
                <div class="flex justify-center absolute -top-3 inset-x-0">
                  <span class="h-6 flex justify-center items-center bg-red-500 text-white text-xs font-semibold tracking-widest uppercase rounded-full px-3 py-1">most popular</span>
                </div>
              ...
              <div class="flex flex-col gap-8 mt-auto">
                ...
                <a href="#" class="block bg-red-500 hover:bg-red-600 active:bg-red-700 focus-visible:ring ring-red-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Continue with Team</a>
              </div>
            </div>
            ...
            <div class="flex flex-col border rounded-lg p-4 pt-6">
              ...
              <div class="flex flex-col gap-8 mt-auto">
                ...
                <a href="#" class="block bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-red-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Contact Sales</a>
              </div>
            </div>
            
          </div>
      
          <div class="text-gray-500 text-sm sm:text-base text-center">Need help deciding? <a href="#" class="text-gray-500 hover:text-red-500 active:text-red-600 underline transition duration-100">Get in touch</a>.</div>
        </div>
      </div>
    );
}
